...
tidy_confirmed = read.csv("data/tidy_confirmed.csv", check.names = FALSE, stringsAsFactors = TRUE, na.strings="")
tidy_confirmed = tidy_confirmed[c(2, 3, 4, 5, 6, 7)]

tidy_recovered = read.csv("data/tidy_recovered.csv", check.names = FALSE, stringsAsFactors = TRUE, na.strings="")
tidy_recovered = tidy_recovered[c(2, 3, 4, 5, 6, 7)]

tidy_deaths = read.csv("data/tidy_deaths.csv", check.names = FALSE, stringsAsFactors = TRUE, na.strings="")
tidy_deaths = tidy_deaths[c(2, 3, 4, 5, 6, 7)]
