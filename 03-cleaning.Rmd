...
write.csv(tidy_confirmed,"data/tidy_confirmed.csv", row.names = F)

tidy_recovered = recovered %>% 
  pivot_longer(cols = !c("Province/State", "Country/Region", "Lat", "Long"), 
               names_to = "Dates", values_to = "Recovered", names_transform = list(Date = format_dates)) %>%
write.csv(tidy_recovered,"data/tidy_recovered.csv", row.names = F)

tidy_deaths = deaths %>% 
  pivot_longer(cols = !c("Province/State", "Country/Region", "Lat", "Long"), 
               names_to = "Dates", values_to = "Deaths", names_transform = list(Date = format_dates))
write.csv(tidy_deaths,"data/tidy_deaths.csv", row.names = F)
